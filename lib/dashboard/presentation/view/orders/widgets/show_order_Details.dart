...
import 'package:supabase_dashboard/dashboard/presentation/view/orders/invoice_pdf.dart';
...
void _showOrderDetails(BuildContext context, OrderModel order) {
    ...
    Future<void> printInvoice(BuildContext context, OrderModel order) async {
    final pdfBytes = await InvoicePDF.generate(order);
